...
Download the <a href="Open With Visual Studio Code.shortcut">vscode shortcut</a> and double click on it to add it to the shortcuts app, you can delete the downloaded file after the shortcut has been added.
